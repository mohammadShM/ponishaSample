                            ...
                            <div class="card-body">
                                ...
                                <div class="direct-chat-messages">
                                    ...
                                    <div class="direct-chat-msg">
                                        ...
                                        <!-- /.direct-chat-info -->
                                        <img class="direct-chat-img" src="{{asset('/AdminFolder/dist/img/user1-128x128.jpg')}}"
                                    ...
                                    <div class="direct-chat-msg right">
                                        ...
                                        <!-- /.direct-chat-info -->
                                        <img class="direct-chat-img" src="{{asset('/AdminFolder/dist/img/user3-128x128.jpg')}}"
                                             alt="message user image">
                                        <!-- /.direct-chat-img -->
                                        <div class="direct-chat-text">
                                            بهتره اینو باور کنی :)
                                        ...
                                        <li>
                                            <a href="#">
                                                <img class="contacts-list-img"
                                                     src="{{asset('/AdminFolder/dist/img/user1-128x128.jpg')}}" alt="">
                          ...
                          <span class="contacts-list-name">
                            ...
                            <small class="contacts-list-date float-left">1397/10/01</small>
                                        ...
                                        <li>
                                            <a href="#">
                                                <img class="contacts-list-img"
                                                     src="{{asset('/AdminFolder/dist/img/user7-128x128.jpg')}}" alt="">
                                                <div class="contacts-list-info">
                          <span class="contacts-list-name">
                            سارا فرهانی
                            <small class="contacts-list-date float-left">2/23/2015</small>
                                        ...
                                        <li>
                                            <a href="#">
                                                <img class="contacts-list-img"
                                                     src="{{asset('/AdminFolder/dist/img/user3-128x128.jpg')}}" alt="">
                                                <div class="contacts-list-info">
                          <span class="contacts-list-name">
                            نکیسا کیانی
                            <small class="contacts-list-date float-left">2/20/2015</small>
                                        ...
                                        <li>
                                            <a href="#">
                                                <img class="contacts-list-img"
                                                     src="{{asset('/AdminFolder/dist/img/user5-128x128.jpg')}}" alt="">
                                                <div class="contacts-list-info">
                          <span class="contacts-list-name">
                            توحید داننده
                            <small class="contacts-list-date float-left">2/10/2015</small>
                                        ...
                                        <li>
                                            <a href="#">
                                                <img class="contacts-list-img" alt=""
                                                     src="{{asset('/AdminFolder/dist/img/user6-128x128.jpg')}}">
                          ...
                          <span class="contacts-list-name">
                            ...
                            <small class="contacts-list-date float-left">1/27/2015</small>
                                        ...
                                        <li>
                                            <a href="#">
                                                <img class="contacts-list-img" alt=""
                                                     src="{{asset('/AdminFolder/dist/img/user8-128x128.jpg')}}">
